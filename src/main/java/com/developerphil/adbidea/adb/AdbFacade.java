...
public class AdbFacade {
    ...
    public static void clearSdcardData(Project project) {
        executeOnDevice(project, new ClearSDcardDataCommand());
    }

    public static void doubleClearData(Project project) {
        executeOnDevice(project, new DoubleClearDataCommand());
    }

    public static void doubleClearDataAndrestart(Project project) {
        executeOnDevice(project, new DoubleClearDataAndRestartCommand(false));
    }

    public static void doubleClearDataAndrestartWithDubg(Project project) {
        executeOnDevice(project, new DoubleClearDataAndRestartCommand(true));
    }
    ...
    public static void getDeviceInfo(Project project) {
        executeOnDevice(project, new GetDeviceInfoCommand());
    }
    ...
    private static void executeOnDevice(final Project project, final Command runnable) {
        ...
        final DeviceResult result = project.getComponent(ObjectGraph.class)
                ...
                .fetch(!(runnable instanceof GetDeviceInfoCommand));
